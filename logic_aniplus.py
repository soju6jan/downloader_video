    ...
    def make_episode_info(self):
        try:
            ...
            data = requests.post('https://api.aniplustv.com:3100/vodUrl', 
                headers=headers, 
                json={"params":{"userid":ModelSetting.get('aniplus_id'),"subPartSerial":self.info['subPartSerial2'],"crypParam":crypParam, 'authId': base64.b64encode(ModelSetting.get('aniplus_id').encode('utf-8')).decode('ute-8'), 'token': get_token()}}
            ).json()[0]
